                ...
                dailyTransactions.map((tx, idx) => {
                  ...
                  return (
                    <tr key={tx.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="py-3 px-4 font-mono font-semibold text-slate-700">{timeStr} WITA</td>
                      ...
                      <td className="py-3 px-4 font-medium text-slate-700">{tx.className}</td>
                      <td className="py-3 px-4">
                        <span
                      ...
                      <td className="py-3 px-4 text-slate-600 max-w-[150px] truncate" title={tx.note}>
                        {tx.note || '-'}
                      </td>
